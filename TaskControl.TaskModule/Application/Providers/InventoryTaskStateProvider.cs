...
{
    // Замените на ваш актуальный интерфейс репозитория назначений инвентаризации, если он отличается
    private readonly IInventoryAssignmentRepository _repository;

    public InventoryTaskStateProvider(IInventoryAssignmentRepository repository)
    {
